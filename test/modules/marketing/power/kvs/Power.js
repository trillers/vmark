...
describe('Power Kvs', function(){
    ...
    describe('savePowerActivity', function(){
        it('succeed to save power activity', function(done){
            co(function*(){
                try{
                    var kv = context.kvs.power;
    ...
    describe('loadPowerActivity', function(){
        it('succeed to load power activity', function(done){
            co(function*(){
                try{
                    var kv = context.kvs.power;
