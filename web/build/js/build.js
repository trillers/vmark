					...
					walk(root, function (dom) {
						if (dom.nodeType == 1) {
							...
							if (childTags) {
								...
								if (child && !dom.isLoop) childTags.push(initChildTag(child, {
									root: dom,
									parent: tag
								}, dom.innerHTML, tag));
							}
