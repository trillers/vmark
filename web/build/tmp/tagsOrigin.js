riot.tag2('accordion', '<nav> <ul class="nav nav-pills nav-stacked"> <li role="presentation" class="{active: useAsDefault}" each="{opts.navs}"> <a href="#{path}">{presentation}</a> </li> </ul> </nav>', 'accordion ul,[riot-tag="accordion"] ul,[data-is="accordion"] ul{ margin: 0px; padding: 0px; }', '', function(opts) {
});
