...
/***/ function(module, exports, __webpack_require__) {
	...
	;(function () {
	  ...
	  */
	  ...
	  var tmpl = function () {
	    ...
	    function tmpl(s, p) {
	      ...
	      replace(brackets(/\\{/g), '￰').replace(brackets(/\\}/g), '￱');
	  ...
	  function Tag(impl, conf) {
	    ...
	    this.unmount = function () {
	      ...
	      if (p) {
	        if (parent) p.removeChild(el);else while (root.firstChild) {
	          ...
	          // show / hide
	            ...
	            // field value
	              ...
	              // <img src="{ expr }">
	                ...
	                if ((typeof value === 'undefined' ? 'undefined' : _typeof(value)) != 'object') dom.setAttribute(attr_name, value);
	              }
	    });
	  }
	  ...
	  */
	  ...
	  // support CommonJS
	  if (( false ? 'undefined' : _typeof(exports)) === 'object') module.exports = riot;
	  ...
	  // support AMD
	    ...
	    // support CMD
	    else if (typeof define === 'function' && define.cmd) define(function (require, exports, module) {
	        module.exports = riot;
	      });
